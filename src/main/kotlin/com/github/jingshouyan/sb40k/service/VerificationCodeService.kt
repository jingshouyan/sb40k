...
interface VerificationCodeService {
     ...
     * @return 验证码记录 id
     */
    fun trigger(account: String, idType: Int, businessType: String, lang: String? = null, params: Map<String, String>? = null): String
     ...
     * @return true=验证通过
     */
    fun verify(id: String, code: String): Boolean
}
